...
public final class MyAzure {
    ...
    public static Configurable configure() {
        return new MyAzure.ConfigurableImpl();
    }
    /**
     ...
     * @return the Azure
     */
    public static MyAzure authenticate(AzureTokenCredentials credentials, String subscriptionId) {
        return new MyAzure(new RestClient.Builder()
    ...
    public static MyAzure authenticate(ApplicationTokenCredentials credentials, String subscriptionId) {
        return new MyAzure(new RestClient.Builder()
                .withBaseUrl(credentials.environment(), AzureEnvironment.Endpoint.RESOURCE_MANAGER)
                .withCredentials(credentials)
                .withSerializerAdapter(new AzureJacksonAdapter())
     ...
     * @return the Azure
     */
    public static MyAzure authenticate(RestClient restClient, String subscriptionId) {
        return new MyAzure(restClient, subscriptionId);
    }
    /**
    ...
    public interface Configurable extends AzureConfigurable<Configurable> {
         ...
         */
        MyAzure authenticate(AzureTokenCredentials credentials, String subscriptionId);
    }
    ...
    private static final class ConfigurableImpl extends AzureConfigurableCoreImpl<Configurable> implements Configurable {
        public MyAzure authenticate(AzureTokenCredentials credentials, String subscriptionId) {
            return MyAzure.authenticate(buildRestClient(credentials), subscriptionId);
        }
    }

    private MyAzure(RestClient restClient, String subscriptionId) {
